...
namespace NetCore_NPOI.Controllers
{
    ...
    class NPOI
    {
        ...
        public void NPOIprintf()
        {
            ...
            Write(workbook2007, @"C:\NPOI_Excel\Excel2007.xlsx");
        }

        public void NPOIRead()
        {
            ISheet sheet = ReadSheetAt(@"C:\NPOI_Excel\Excel2007.xlsx", 0);  //獲取第一個工作表
